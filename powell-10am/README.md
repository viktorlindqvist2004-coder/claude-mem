...
src/models/      Model registry + multi-model scan, with conflict semantics
...
| [14 — Mech Model](docs/14-mech-model.md) | A second model: declared, **not encoded**, and what it needs |

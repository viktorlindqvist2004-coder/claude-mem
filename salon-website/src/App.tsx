      ...
      <section id="hero" className="relative h-screen overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-5">
          <div className={`stagger-children ${heroReady ? 'active' : ''}`}>
            ...
            <button onClick={() => scrollTo('booking')}
              className="inline-block mt-8 bg-transparent border border-[#d4af37]/40 text-[#d4af37] text-[11px] font-bold px-10 py-4 tracking-[0.3em] uppercase hover:bg-[#d4af37] hover:text-black transition-all duration-500 cursor-pointer pulse-glow">
              Boka Din Tid
            </button>
          </div>
        </div>

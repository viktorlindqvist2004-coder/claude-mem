          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-10">
            <FadeIn delay={200}>
              <div className="space-y-8">
                ...
                <button onClick={() => scrollTo('booking')}
                  className="inline-block border border-[#d4af37]/40 text-[#d4af37] text-xs font-bold px-8 py-3.5 tracking-[0.2em] uppercase bg-transparent cursor-pointer hover:bg-[#d4af37] hover:text-black transition-all duration-500">
                  Boka Din Tid
                </button>
              </div>
            </FadeIn>
